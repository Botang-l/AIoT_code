...
def Model_args():
    ...
    parser.add_argument('--epochs', type=int, default=2000, help='訓練回合數')
    parser.add_argument('--batch_size', type=int, default=60, help='批次大小')
    ...
    parser.add_argument('--patience', type=int, default=10, help='幾次不下降更新學習率')
    # ------StepLR (固定回合調整學習率)
